...
<template>
  <div id="contact">
    <div class="content">
      <h3>Контакты</h3>
      <p class="text-grey">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab ad at consequuntur culpa deleniti et illum in
        inventore ipsam iure nesciunt numquam, quos repellendus saepe sapiente sequi, totam? At, nesciunt.
      </p>
      <ul>
        <li>
    ...
    <div class="image">
      <img src="/images/5fa4129180846424792156.jpg">
    </div>
  </div>
</template>
